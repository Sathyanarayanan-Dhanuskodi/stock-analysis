...
SECTOR_STOCKS = {
    ...
    "FMCG": ["HINDUNILVR.NS", "ITC.NS", "NESTLEIND.NS", "BRITANNIA.NS", "TATACONSUM.NS", "TRENT.NS"],
    "Auto": ["MARUTI.NS", "TATAMOTORS.NS", "M&M.NS", "BAJAJ-AUTO.NS", "EICHERMOT.NS", "HEROMOTOCO.NS"],
    "Pharma": ["SUNPHARMA.NS", "DRREDDY.NS", "CIPLA.NS", "DIVISLAB.NS", "APOLLOHOSP.NS"],
    "Energy": ["RELIANCE.NS", "ONGC.NS", "BPCL.NS", "COALINDIA.NS", "ADANIENT.NS"],
    "Metals": ["TATASTEEL.NS", "HINDALCO.NS", "JSWSTEEL.NS", "GRASIM.NS"],
    "Infrastructure": ["LT.NS", "ULTRACEMCO.NS", "POWERGRID.NS", "NTPC.NS", "ADANIPORTS.NS", "BEL.NS"],
    "Financial Services": ["BAJFINANCE.NS", "BAJFINSV.NS", "SBILIFE.NS", "HDFCLIFE.NS", "SHRIRAMFIN.NS"],
    "Consumer": ["TITAN.NS", "ASIANPAINT.NS", "ETERNAL.NS"],
